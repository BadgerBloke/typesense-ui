'use client';
import { Fragment, use, useActionState, useState } from 'react';
...
import CollectionList from '../add/_components/collection-list';

import { createAPIKey, State } from './action';

const ApiKeyCreationCard = ({ collectionsPromise }: { collectionsPromise: Promise<CollectionSchema[]> }) => {
    const collections = use(collectionsPromise);
    const [expiresAt, setExpiresAt] = useState<Date>();
    const [state, formAction] = useActionState(createAPIKey, { error: {} });
